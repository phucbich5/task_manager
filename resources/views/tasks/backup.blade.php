                            ...
                            <span
                                ...
                                @if ($s->status == 'review')
                                    ...
                                    <span class="ml-2 text-green-500"
                                        wire.click="mark_status_complete({{ $s->task_id, $s->id }})"><i
                                ...
                                @elseif($s->status == 'progress')
                                    ...
                                    {{-- <span class="ml-2 text-green-500" wire.click="mark_status_complete({{$s->task_id,$s->id}})"><i class="fas fa-check"></i></span> --}}
                                ...
                                @elseif($s->status == 'not started')
                                    ...
                                    <button class="ml-2 text-green-500" type="button"
                                        wire:click="changestatus({{ $s->id }})"><i
