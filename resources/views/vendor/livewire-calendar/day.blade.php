...
<div
    ...
    class="flex-1 h-40 -mt-px -ml-px border border-gray-200 lg:h-48"
    ...
    <div
        ...
        <div
            ...
            @endif
            class="w-full h-full p-2 {{ $dayInMonth ? $isToday ? 'bg-green-200' : ' bg-white ' : 'bg-red-100' }} flex flex-col">
            ...
            {{-- Events --}}
            <div class="flex-1 p-2 my-2 overflow-y-auto">
